            ...
            <div class="card text-center text-white bg-success">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-text">Kamu dinyatakan <strong>LULUS</strong> dalam seleksi <strong>Penerimaan
                            Peserta Didik Baru (PPDB)</strong> Sekolah Dasar Negeri 11 Kota Jambi.</h5>
            ...
            <div class="card text-center text-white bg-warning">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-text">Mohon menunggu <strong>INFORMASI</strong> dari Panitia <strong>Penerimaan
                            Peserta Didik Baru (PPDB)</strong> Sekolah Dasar Negeri 11 Kota Jambi.</h5>
                    <h5>Untuk melihat hasil seleksi, Kamu dapat Login Kembali dengan <u><strong>Nomor Register :
