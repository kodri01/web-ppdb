                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    @if ($siswa->status_siswa == 'Siswa Baru')
                                        ...
                                        @if ($siswa->asal_siswa == 'Rumah Tangga')
                                            <div></div>
                                        @else
                                            <div class="input-group mb-2">
                                            ...
                                            <div class="input-group mb-2">
                                                <div class="input-group-text">Tanggal STTB</div>
                                                <input type="text" class="form-control" disabled
                                                    value="{{ date('d F Y', strtotime($siswa->tgl_sttb)) }}"
                                                    id="specificSizeInputGroupUsername">
                                            </div>
                                            <div class="input-group mb-2">
                                                <div class="input-group-text">Nomor STTB</div>
                                                <input type="text" class="form-control" disabled
                                    ...
                                    @if ($bayar != null)
                                        <div class="card">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="text" class="form-control" disabled
                                                    value="{{ $bayar->nominal }}" id="specificSizeInputGroupUsername">
                                            </div>
