                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="pendapatan_ayah" id="kewarganegaraan"
                                                                ...
                                                                <option value="Rp. 1.000.000 - Rp. 2.500.000">Rp. 1.000.000
                                                                    - Rp.
                                                                    2.500.000</option>
                                                                <option value="Rp. 2.500.000 - Rp. 5.000.000">Rp. 2.500.000
                                                                    - Rp.
                                                                    5.000.000</option>
                                                                <option value="Rp. 5.000.000 - Rp. 10.000.000">Rp.
                                                                    5.000.000 - Rp.
                                                                    10.000.000</option>
                                                            </select>
